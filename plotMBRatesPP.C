...
//Reset ROOT and connect tree file
   ...
   for (Long64_t i=0; i<nentries;i++) {
      ...
      if(HLT_DmesonPPTrackingGlobal_Dpt8_v1)counter_HLT_DmesonPPTrackingGlobal_Dpt8_v1++;
      if(HLT_DmesonPPTrackingGlobal_Dpt15_v1)counter_HLT_DmesonPPTrackingGlobal_Dpt15_v1++;
      if(HLT_DmesonPPTrackingGlobal_Dpt20_v1)counter_HLT_DmesonPPTrackingGlobal_Dpt20_v1++;
      if(HLT_DmesonPPTrackingGlobal_Dpt30_v1)counter_HLT_DmesonPPTrackingGlobal_Dpt30_v1++;
      if(HLT_DmesonPPTrackingGlobal_Dpt40_v1)counter_HLT_DmesonPPTrackingGlobal_Dpt40_v1++;
      if(HLT_DmesonPPTrackingGlobal_Dpt50_v1)counter_HLT_DmesonPPTrackingGlobal_Dpt50_v1++;
      if(HLT_DmesonPPTrackingGlobal_Dpt60_v1)counter_HLT_DmesonPPTrackingGlobal_Dpt60_v1++;
      if(HLT_AK4PFBJetBSSV80_Eta2p1_v1)counter_HLT_AK4PFBJetBSSV80_Eta2p1_v1++;
      if(HLT_AK4PFBJetBSSV60_Eta2p1_v1)counter_HLT_AK4PFBJetBSSV60_Eta2p1_v1++;
      if(HLT_AK4PFBJetBCSV80_Eta2p1_v1)counter_HLT_AK4PFBJetBCSV80_Eta2p1_v1++;
      if(HLT_AK4PFBJetBCSV60_Eta2p1_v1)counter_HLT_AK4PFBJetBCSV60_Eta2p1_v1++;
